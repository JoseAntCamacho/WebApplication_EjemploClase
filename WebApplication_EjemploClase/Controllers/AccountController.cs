...
using WebApplication_EjemploClase.Models;
using WebApplication_EjemploClase.Providers;
using WebApplication_EjemploClase.Results;

namespace WebApplication_EjemploClase.Controllers
{
    [Authorize]
